...
async def advantage_spoll_choker(bot, query):
    ...
    if k == False:
        ...
        if files:
            ...
            k = await query.message.edit("<b>💌 This Movie is not yet Released Or Added to my Database 💌</b>\n› <a href=https://t.me/RolexMoviesOX><b>Check In This Channel</b></a>", disable_web_page_preview=True)
